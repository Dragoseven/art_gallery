...
const artPieces = [
	...
	{ img: '/art_gallery/Anya Taylor-Joy - The Queen\'s Gambit2.jpg', name: "Anya Taylor-Joy - The Queen's Gambit (Alt)", artist: 'Unknown', desc: "Another captivating portrait from The Queen's Gambit series." },
	{ img: '/art_gallery/Baby Yoda Bill.jpg', name: 'Baby Yoda Bill', artist: 'Unknown', desc: 'An adorable portrait of Baby Yoda.' },
	{ img: '/art_gallery/Blonde Girl with Goggles2.jpg', name: 'Blonde Girl with Goggles (Alt)', artist: 'Unknown', desc: 'Another perspective of the blonde girl with goggles.' },
	{ img: '/art_gallery/Brad Pitt.jpg', name: 'Brad Pitt', artist: 'Unknown', desc: 'A captivating portrait of Brad Pitt.' },
	{ img: '/art_gallery/Cat Stare.jpg', name: 'Cat Stare', artist: 'Unknown', desc: 'An intense and mesmerizing cat stare.' },
	{ img: '/art_gallery/Color Dash Equestrian.jpg', name: 'Color Dash Equestrian', artist: 'Unknown', desc: 'A vibrant equestrian scene with dashing colors.' },
	{ img: '/art_gallery/Dead Cyborg Insect.jpg', name: 'Dead Cyborg Insect', artist: 'Unknown', desc: 'A surreal depiction of a dead cyborg insect.' },
	{ img: '/art_gallery/Gorilla Joy.jpg', name: 'Gorilla Joy', artist: 'Unknown', desc: 'A joyful gorilla captured in a moment of happiness.' },
	{ img: '/art_gallery/Gorilla with Purse.jpg', name: 'Gorilla with Purse', artist: 'Unknown', desc: 'A humorous portrait of a gorilla holding a purse.' },
	{ img: '/art_gallery/Jung Ho-yeon - Squid Game.jpg', name: 'Jung Ho-yeon - Squid Game', artist: 'Unknown', desc: 'A powerful portrait of Jung Ho-yeon from Squid Game.' },
	{ img: '/art_gallery/Leaf Life.jpg', name: 'Leaf Life', artist: 'Unknown', desc: 'A serene depiction of life through the lens of a leaf.' },
	{ img: '/art_gallery/Leonardo Dicaprio - Wolf of Wall Street - Cash.jpg', name: 'Leonardo DiCaprio - Wolf of Wall Street', artist: 'Unknown', desc: 'Leonardo DiCaprio surrounded by cash from The Wolf of Wall Street.' },
	{ img: '/art_gallery/Leonardo Dicaprio.jpg', name: 'Leonardo DiCaprio', artist: 'Unknown', desc: 'A classic portrait of Leonardo DiCaprio.' },
	{ img: '/art_gallery/Louie V Raven.jpg', name: 'Louie V Raven', artist: 'Unknown', desc: 'A stylish raven with Louis Vuitton flair.' },
	{ img: '/art_gallery/Maple Syrup.jpg', name: 'Maple Syrup', artist: 'Unknown', desc: 'A sweet and delicious depiction of maple syrup.' },
	{ img: '/art_gallery/Mario Bill.jpg', name: 'Mario Bill', artist: 'Unknown', desc: "A playful portrait of Mario's Bullet Bill." },
	{ img: '/art_gallery/Marylin Monroe.jpg', name: 'Marilyn Monroe', artist: 'Unknown', desc: 'An iconic portrait of Marilyn Monroe.' },
	{ img: '/art_gallery/Penguin - Batman2.jpg', name: 'Penguin - Batman (Alt)', artist: 'Unknown', desc: "Another menacing portrait of Batman's Penguin." },
	{ img: '/art_gallery/Prince.jpg', name: 'Prince', artist: 'Unknown', desc: 'A legendary portrait of the artist Prince.' },
	{ img: '/art_gallery/Retired Batman.jpg', name: 'Retired Batman', artist: 'Unknown', desc: 'Batman in his later years, retired but still heroic.' },
	{ img: '/art_gallery/Thoughts - Maksim Sarkysian.jpg', name: 'Thoughts', artist: 'Maksim Sarkysian', desc: 'A contemplative piece titled "Thoughts" by Maksim Sarkysian.' },
	{ img: '/art_gallery/Zendaya - Dune.jpg', name: 'Zendaya - Dune', artist: 'Unknown', desc: 'A stunning portrait of Zendaya from Dune.' },
];
